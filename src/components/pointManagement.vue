...
import floorImg1 from '../assets/1.png'
import floorImg2 from '../assets/2.jpg'
import floorImg3 from '../assets/3.jpg'
import floorImg4 from '../assets/4.jpeg'
import deviceImg1 from '../assets/icon1.png'
import deviceImg2 from '../assets/icon2.png'
import deviceImg3 from '../assets/icon3.png'
import deviceImg4 from '../assets/icon4.png'
import deviceImg5 from '../assets/icon5.png'
import deviceImg6 from '../assets/icon6.png'
import deviceImg7 from '../assets/icon7.png'
import deviceImg8 from '../assets/icon8.png'
import deviceImg9 from '../assets/icon9.png'
...
const deviceTree = ref<DeviceChildren[]>([
  {
    id: 0,
    label: '点位1',
    url: deviceImg1,
